        ...
        <transition :name="'move-' + placement" @after-leave="wrapShow = false">
          <div :class="classes" :style="mainStyles" v-show="visible">
            <div :class="contentClasses" ref="content">
              <a class="yun-drawer-close" v-if="showClose" @click="close">
                <slot name="close">
                  <i class="b-iconfont b-icon-close"></i>
                </slot>
              </a>
              <div class="yun-drawer-header" v-if="$slots.header || title">
                <slot name="header">
                  <div class="yun-drawer-header-inner">{{ title }}</div>
                </slot>
              </div>
              <div class="yun-drawer-body" :style="styles">
                <slot></slot>
              </div>
              <div class="yun-drawer-footer" v-if="$slots.footer">
            ...
            <div
              class="yun-drawer-drag"
              :class="{ 'yun-drawer-drag-left': placement === 'left' }"
              v-if="draggable"
              @mousedown="handleTriggerMousedown"
            >
              <slot name="trigger">
                <div class="yun-drawer-drag-move-trigger">
                  <div class="yun-drawer-drag-move-trigger-point"><i></i><i></i><i></i><i></i><i></i></div>
                </div>
              </slot>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    handleWrapClick(event) {
      // use indexOf,do not use === ,because yun-modal-wrap can have other custom className
