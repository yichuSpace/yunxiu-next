<template>
  <div class="yun-anchor-wrapper" ref="container">
    <div class="yun-anchor">
      <div class="yun-anchor-ink">
        <yun-icon v-if="icon" :name="icon" :style="iconStyle" :color="activeColorStr"></yun-icon>
        <span
          v-show="!icon && showInk"
          class="yun-anchor-ink-ball"
          :style="{ borderColor: activeColorStr, top: `${inkTop}px` }"
        ></span>

        <span
          v-show="!icon && !showInk"
          class="yun-anchor-ink-line"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    provide('YunAnchor', { props, data, linksRef })
