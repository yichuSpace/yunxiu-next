<template>
  <div
    class="yun-splitter-container clear-fix"
    :class="{ 'hide-line': hideLine, 'is-active': active }"
    @mouseup="onMouseUp"
    @mousemove="onMouseMove"
  >
    <pane class="yun-splitter-pane splitter-left" :split="split" :style="leftStyle">
      <slot name="left"></slot>
    </pane>
    ...
    <pane class="yun-splitter-pane splitter-right" :split="split" :style="rightStyle">
      <slot name="right">
        <p>type: {{ type }}</p>
