...
export default {
  ...
  setup(props) {
    const descriptions = inject('YunDesc', {})
    ...
    switch (this.type) {
      case 'label':
        return h(
          this.tag,
          {
            class: ['yun-desc__label', { 'is-bordered-label': this.descriptions.border }],
      ...
      default:
        return h(
          ...
          [
            h('span', { class: 'yun-desc__label' }, this.label),
            h('span', { class: 'yun-desc__content' }, this.content),
          ],
        )
    }
  },
