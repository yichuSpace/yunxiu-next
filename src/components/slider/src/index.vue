<template>
  <div class="yun-slider-wrapper">
    <div
      ref="sliderWrapper"
      class="yun-slider"
      :class="{ 'is-vertical': vertical, 'yun-slider--with-input': showInput }"
      role="slider"
      :aria-valuemin="min"
      :aria-valuemax="max"
    ...
    >
      ...
      <div
        ref="slider"
        class="yun-slider__runway"
        :class="{ 'show-input': showInput, disabled: sliderDisabled }"
        :style="runwayStyle"
        @click="onSliderClick"
      >
        <div class="yun-slider__bar" :style="barStyle"></div>
        <slider-button ref="firstButton" v-model="firstValue" :vertical="vertical" :tooltip-class="tooltipClass" />
        <slider-button
          v-if="range"
          ref="secondButton"
          v-model="secondValue"
        ...
        />
        <div v-if="showStops">
          <div v-for="(item, key) in stops" :key="key" class="yun-slider__stop" :style="getStopStyle(item)"></div>
        </div>
        <template v-if="markList.length > 0">
          <div>
            <div
              ...
              class="yun-slider__stop yun-slider__marks-stop"
            ></div>
          </div>
          <div class="yun-slider__marks">
            <slider-marker
              v-for="(item, key) in markList"
              :key="key"
              :mark="item.mark"
...
import YunInputNumber from '../../input-number'
