<template>
  <div
    class="yun-picker-panel yun-date-picker"
    :class="[
      {
  ...
  >
    <div class="yun-picker-panel__body-wrapper">
      ...
      <div class="yun-picker-panel__body">
        <div v-if="showTime" class="yun-date-picker__time-header">
          <span class="yun-date-picker__editor-wrap">
            <b-input
              placeholder="选择日期"
          ...
          <span v-click-outside="handleTimePickClose" class="yun-date-picker__editor-wrap">
            <b-input
              placeholder="选择时间"
        ...
        <div
          ...
          class="yun-date-picker__header"
          :class="{ 'yun-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
        >
          <button
            type="button"
            aria-label="上一年"
          ...
          <span role="button" class="yun-date-picker__header-label" @click="showYearPicker">{{ yearLabel }}</span>
          <span
            v-show="currentView === 'date'"
            role="button"
            class="yun-date-picker__header-label"
        ...
        <div class="yun-picker-panel__content">
          <date-table
    ...
    <div v-show="footerVisible && currentView === 'date'" class="yun-picker-panel__footer">
      <b-button
        v-show="selectionMode !== 'dates'"
        size="mini"
        type="text"
        class="yun-picker-panel__link-btn"
        @click="changeToNow"
      >
        此刻
      </b-button>
      <b-button type="primary" size="mini" class="yun-picker-panel__link-btn" @click="onConfirm">
        确定
      </b-button>
    </div>
  </div>
...
<script>
import { extractDateFormat, extractTimeFormat, TimePickPanel } from '../../time-picker'
