<template>
  <div class="yun-calendar" :class="{ card: mini }">
    <div class="yun-calendar-header">
      <template v-if="mini">
        <span>{{ headerTitle }}</span>
        <yun-button-group>
          <yun-button size="mini" @click="handlePrevMonth" icon="doubleleft"></yun-button>
          <yun-button size="mini" @click="handleToday">今天</yun-button>
          <yun-button size="mini" @click="handleNextMonth" icon="doubleright"></yun-button>
        </yun-button-group>
      </template>
      <template v-else>
        <div class="yun-calendar-header-title">
          {{ headerTitle }}
        </div>
        <yun-button-group>
          <yun-button size="mini" @click="handlePrevMonth">上个月</yun-button>
          <yun-button size="mini" @click="handleToday">今天</yun-button>
          <yun-button size="mini" @click="handleNextMonth">下个月</yun-button>
        </yun-button-group>
      </template>
    </div>
    <ul class="yun-calendar-week">
      <li
        v-for="(item, index) in ['一', '二', '三', '四', '五', '六', '日']"
        :key="index"
        class="yun-calendar-week-item"
      >
        {{ item }}
      </li>
    </ul>
    <ul class="yun-calendar-body" :style="bodyStyle">
      <li
        v-for="(item, index) in visibleCalendar"
        :key="index"
        class="yun-calendar-date-view"
        :style="dateViewStyle"
...
import YunButtonGroup from '../button-group'
...
export default {
  name: 'YunCalendar',
  components: { YunButton, YunButtonGroup },
  props: {
    gridHeight: String,
    textAlign: String,
    mini: Boolean,
