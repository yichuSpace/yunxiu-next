<template>
  <ul :class="simpleWrapClasses" :style="styles" v-if="simple">
    <li title="上一页" :class="prevClasses" @click="prev">
      <a><i class="yun-iconfont yun-icon-left"></i></a>
    </li>
    ...
    <li title="下一页" :class="nextClasses" @click="next">
      <a><i class="yun-iconfont yun-icon-right"></i></a>
    </li>
  </ul>
  <ul :class="wrapClasses" :style="styles" v-else>
    ...
    <li title="上一页" :class="prevClasses" @click="prev">
      <a>
        ...
        <i v-else class="yun-iconfont yun-icon-left"></i
      ></a>
    </li>
    ...
    <li title="向前5页" v-if="currentPage > 5" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev">
      <a><i class="yun-iconfont yun-icon-doubleleft"></i></a>
    </li>
    <li
      :title="currentPage - 3"
      v-if="currentPage === 5"
    ...
    <li title="向后5页" v-if="allPages - currentPage >= 5" :class="[prefixCls + '-item-jump-next']" @click="fastNext">
      <a><i class="yun-iconfont yun-icon-doubleright"></i></a>
    </li>
    ...
    <li title="下一页" :class="nextClasses" @click="next">
      <a>
        ...
        <i v-else class="yun-iconfont yun-icon-right"></i
      ></a>
    </li>
    <options
...
const prefixCls = 'yun-pagination'
