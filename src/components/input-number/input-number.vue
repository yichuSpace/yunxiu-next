<template>
  <div
    :class="[
      'yun-input-number',
      {
        [`yun-input-number-${inputSize}`]: !!inputSize,
        ['yun-input-number-disabled']: inputDisabled,
        ['yun-input-number-focused']: focused,
        ['yun-input-number-always']: always,
      },
    ]"
  >
    <template v-if="always">
      <a @click="down" :class="minusClasses">
        <i class="yun-iconfont yun-icon-minus"></i>
      </a>
      <a @click="up" :class="plusClasses">
        <i class="yun-iconfont yun-icon-plus"></i>
      </a>
    </template>
...
const prefixCls = 'yun-input-number'
...
export default {
  ...
  setup(props, ctx) {
    ...
    const inputDisabled = computed(() => props.disabled || YunForm.disabled)
    const inputSize = computed(() => props.size || YunForm.size || YunFormItem.size)
  ...
  computed: {
    ...
    innerUpClasses() {
      return `${prefixCls}-handler-up-inner yun-iconfont yun-icon-up`
    },
    downClasses() {
      return [
        `${prefixCls}-handler`,
    ...
    innerDownClasses() {
      return `${prefixCls}-handler-down-inner yun-iconfont yun-icon-down`
    },
    inputWrapClasses() {
