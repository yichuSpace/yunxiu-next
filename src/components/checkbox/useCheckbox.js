...
export const useCheckboxGroup = () => {
  ...
  const isGroup = computed(() => checkboxGroup && checkboxGroup?.name === 'YunCheckboxGroup')
  return {
    isGroup,
    checkboxGroup,
    YunForm,
...
const useDisabled = (props, { model, isChecked }) => {
  const { isGroup, checkboxGroup, YunForm } = useCheckboxGroup()
  ...
  const isDisabled = computed(() => {
    const disabled = props.disabled || YunForm.disabled
