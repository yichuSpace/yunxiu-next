<template>
  <div v-if="actualVisible" class="yun-time-range-picker yun-picker-panel">
    <div class="yun-time-range-picker__content">
      <div class="yun-time-range-picker__cell">
        <div class="yun-time-range-picker__header">开始时间</div>
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
          class="yun-time-range-picker__body yun-time-panel__content"
        >
          <time-spinner
            ref="minSpinner"
            role="start"
      ...
      <div class="yun-time-range-picker__cell">
        <div class="yun-time-range-picker__header">结束时间</div>
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
          class="yun-time-range-picker__body yun-time-panel__content"
        >
...
export default {
  components: { YunButton, TimeSpinner },
